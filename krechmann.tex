...
\begin{tikzpicture}
\begin{axis}[line width=2,enlargelimits=false,ylabel=$ R $,xlabel=$k/k_0$,label style={font=\bfseries\Large},legend style={at={( 0.8,0.2)}, anchor=north west, font=\small},tick label style={font=\bfseries},grid=major]
